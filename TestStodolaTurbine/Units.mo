  ...
  package SI
   ...
   // Complex types for electrical systems (not defined in ISO 31-1992)
    operator record ComplexCurrent =
      Complex(redeclare Units.SI.Current re,
               redeclare Units.SI.Current im)
      "Complex electrical current";
    operator record ComplexCurrentSlope =
      Complex(redeclare Units.SI.CurrentSlope re,
               redeclare Units.SI.CurrentSlope im)
      "Complex current slope";
    operator record ComplexCurrentDensity =
      Complex(redeclare Units.SI.CurrentDensity re,
               redeclare Units.SI.CurrentDensity im)
      "Complex electrical current density";
    operator record ComplexElectricPotential =
      Complex(redeclare Units.SI.ElectricPotential re,
               redeclare Units.SI.ElectricPotential im)
      "Complex electric potential";
    operator record ComplexPotentialDifference =
      Complex(redeclare Units.SI.PotentialDifference re,
               redeclare Units.SI.PotentialDifference im)
      "Complex electric potential difference";
    operator record ComplexVoltage =
      Complex(redeclare Units.SI.Voltage re,
               redeclare Units.SI.Voltage im)
      "Complex electrical voltage";
    operator record ComplexVoltageSlope =
      Complex(redeclare Units.SI.VoltageSlope re,
               redeclare Units.SI.VoltageSlope im)
      "Complex voltage slope";
    operator record ComplexElectricFieldStrength =
      Complex(redeclare Units.SI.ElectricFieldStrength re,
               redeclare Units.SI.ElectricFieldStrength im)
      "Complex electric field strength";
    operator record ComplexElectricFluxDensity =
      Complex(redeclare Units.SI.ElectricFluxDensity re,
               redeclare Units.SI.ElectricFluxDensity im)
      "Complex electric flux density";
    operator record ComplexElectricFlux =
      Complex(redeclare Units.SI.ElectricFlux re,
               redeclare Units.SI.ElectricFlux im)
      "Complex electric flux";
    operator record ComplexMagneticFieldStrength =
      Complex(redeclare Units.SI.MagneticFieldStrength re,
               redeclare Units.SI.MagneticFieldStrength im)
      "Complex magnetic field strength";
    operator record ComplexMagneticPotential =
      Complex(redeclare Units.SI.MagneticPotential re,
               redeclare Units.SI.MagneticPotential im)
      "Complex magnetic potential";
    operator record ComplexMagneticPotentialDifference =
      Complex(redeclare Units.SI.MagneticPotentialDifference re,
               redeclare Units.SI.MagneticPotentialDifference im)
      "Complex magnetic potential difference";
    operator record ComplexMagnetomotiveForce =
      Complex(redeclare Units.SI.MagnetomotiveForce re,
               redeclare Units.SI.MagnetomotiveForce im)
      "Complex magneto motive force";
    operator record ComplexMagneticFluxDensity =
      Complex(redeclare Units.SI.MagneticFluxDensity re,
               redeclare Units.SI.MagneticFluxDensity im)
      "Complex magnetic flux density";
    operator record ComplexMagneticFlux =
      Complex(redeclare Units.SI.MagneticFlux re,
               redeclare Units.SI.MagneticFlux im)
